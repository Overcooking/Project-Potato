...
public class RecipeHandler {
	...
	public static void registerCraftingRecipes() {
		...
		registerArmorRecipes(ModArmor.PotatoInfusedHelmet, ModArmor.PotatoInfusedChestplate, ModArmor.PotatoInfusedLeggings, ModArmor.PotatoInfusedBoots, ModItems.PotatoInfusedIngot);
	...
	private static void registerArmorRecipes(Item helmet, Item chestplate, Item leggings, Item boots, Item material) {
		GameRegistry.addRecipe(new ItemStack(helmet), new Object[] { "III","I I","   ",'I',material});
		GameRegistry.addRecipe(new ItemStack(helmet), new Object[] { "   ","III","I I",'I',material});
		GameRegistry.addRecipe(new ItemStack(chestplate), new Object[] { "I I","III","III",'I',material});
